...
public interface AppConstants {
    ...
    String WRITE_KEY_FOR_ENCRYPT = "Пожалуйства, введите сдвиг по алфавиту (ключ для шифра Цезаря).";
    ...
    String VALUE_NOT_INTEGER = "Введеное вами значение не является числом!";
